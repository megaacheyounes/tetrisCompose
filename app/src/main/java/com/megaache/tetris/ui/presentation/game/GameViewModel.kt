...
import com.megaache.tetris.core.*
import com.megaache.tetris.core.Spirit.Companion.Empty
import com.megaache.tetris.ui.presentation.game.components.TetrisFrameTheme
...
class GameViewModel : ViewModel() {
    ...
    var theme = TetrisFrameTheme.random()

    private val _viewState: MutableState<ViewState> = mutableStateOf(ViewState(theme = theme))
